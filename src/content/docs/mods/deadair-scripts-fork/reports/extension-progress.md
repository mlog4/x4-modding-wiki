...
> **📷 Screenshot needed:** DA Information Menus → Extension report.
> _File: `report-extension.jpg`_

## Related

- [6h TTL on Extension Built lists](../../mechanics/#6h-ttl-on-extension-built-lists) — the underlying data structure and migration story.
- [Mlog: Extension](../../configuration/extension/) — the parent configuration menu.
