...
> **📷 Screenshot needed:** DA Information Menus → Blueprint Scan progress.
> _File: `report-bp-progress.jpg`_

## Related

- [DA Blueprint Analysis](../../configuration/blueprint-analysis/) — the parent configuration menu.
